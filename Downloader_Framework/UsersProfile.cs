...
{
    public class UsersProfile : Panel
    {
        ...
        public UsersProfile(string nameProfile, List<AppToDownload> listApps)
        {
            try
            {
            ...
            txtbox_ProfileName.Size = new Size(136, 23);
            ...
            btn_CopyProfile.Location = new Point(150, 8);
            btn_CopyProfile.Name = "btn_CopyProfile";
            btn_CopyProfile.Size = new Size(91, 23);
            ...
            btn_DeleteProfile.Location = new Point(797, 7);
            btn_DeleteProfile.Name = "btn_DeleteProfile";
            btn_DeleteProfile.Size = new Size(118, 23);
